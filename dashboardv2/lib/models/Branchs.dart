...
class Branchs extends DataTableSource {
  Branchs({
    this.code,
    ...
    try {
      if (index < rowCount)
        return DataRow.byIndex(index: index, cells: [
          DataCell(Text(branch[index].location!.wilaya!.name ?? "No Fournis")),
          DataCell(Text(branch[index].location!.daira!.name ?? "No Fournis ")),
          DataCell(Text(branch[index].location!.commune!.name)),
          DataCell(Text(branch[index].email ?? "No Fournis")),
          DataCell(Text(branch[index].phones?.first.phone ?? "No Fournis")),
          DataCell(Row(
            children: [
              IconButton(
                  onPressed: () {},
  ...
  int get rowCount => branch.length;
...
class Branch {
  ...
  factory Branch.fromJson(Map<String, dynamic> json) => Branch(
        ...
        location: (json.containsKey("location"))
            ...
            : null,
        mapLink:
            (json.containsKey("map_link")) ? json["map_link"] : "no MapLink",
        phones: (json.containsKey("phones"))
